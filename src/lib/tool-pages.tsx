...
export const TOOL_PAGES = {
  formatter: {
    ...
    faqs: [
      ...
      {
        q: "Can JSONova format invalid JSON?",
  ...
  validator: {
    ...
    faqs: [
      {
        q: "How does JSONova show invalid JSON?",
      ...
      },
      {
        ...
        a: "Yes. JSONova includes repair assistance for common mistakes like trailing commas and lightly malformed input.",
      },
      sharedFaqs.privacy,
      {
  ...
  jwt: {
    ...
    faqs: [
      {
        q: "Can JSONova verify JWT signatures?",
    ...
    faqs: [
      {
        ...
        a: "Yes. JSONova's diff view shows original and modified JSON in two independent panes.",
      },
      {
  ...
  graph: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. JSONova's graph view includes layout direction controls.",
      },
      sharedFaqs.privacy,
      {
  ...
  csv: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "JSONova now shows a clear message explaining that CSV expects an array of objects.",
      },
      sharedFaqs.privacy,
      {
  ...
  mock: {
    ...
    faqs: [
      {
        q: "How does JSONova decide what values to generate?",
