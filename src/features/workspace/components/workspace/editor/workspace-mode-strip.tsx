      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between xl:gap-4">
        <div ref={modeMenuRef} className="relative w-full xl:w-auto">
          <button
            ...
            className="flex h-10 w-full items-center justify-between rounded-[10px] border-[0.5px] border-ui-border bg-surface-elevated px-4 text-left transition-colors hover:border-ui-border-hover focus-visible:border-[#C07040] focus-visible:outline-none xl:min-w-[220px]"
          >
            <div>
              <p className="text-[15px] font-medium text-text-primary">{roleMode} mode</p>
            </div>
            <ChevronDown
          ...
          {showModeMenu ? (
            <div className="absolute left-0 top-[calc(100%+8px)] z-20 w-full overflow-hidden rounded-[12px] border-[0.5px] border-ui-border bg-surface-elevated xl:w-[320px]">
              <div className="border-b-[0.5px] border-ui-border px-4 py-3">
                <p className="text-[11px] font-medium tracking-[0.04em] text-text-tertiary">Mode</p>
              </div>
              <div className="p-2">
                {ROLE_MODES.map((item) => (
                  <button
                  ...
                  >
                    ...
                    <span className="mt-1 text-[13px] font-normal leading-[1.5] text-text-secondary">
        ...
        <div className="flex w-full items-center gap-1 overflow-x-auto rounded-sm border-[0.5px] border-ui-border bg-surface-elevated p-1 xl:w-auto">
          <IconButton
